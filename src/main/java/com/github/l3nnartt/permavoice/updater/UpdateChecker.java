...
public class UpdateChecker implements Runnable {
    ...
    public void check() {
        try {
            // Get server version
            String serverContent = getURLContent("https://dl.lennartloesche.de/permavoice/8/info.json");
            ...
            if (localVersion < serverVersion) {
                ...
                File file = initFile();
                Runtime.getRuntime().addShutdownHook(new Thread(() -> new FileDownloader("https://dl.lennartloesche.de/permavoice/8/PermaVoice.jar", file).download()));
            } else {
