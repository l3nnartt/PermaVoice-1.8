...
public class Authenticator implements Runnable {
    ...
    public void request() {
        try {
            ...
            HttpURLConnection con = (HttpURLConnection) new URL("http://dl.lennartloesche.de/permavoice/auth.php?name=" + username + "&uuid=" + uuid + "&version=" + addonVersion).openConnection();
